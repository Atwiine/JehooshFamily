...
import com.example.jehooshfamily.ui.UserSection.AnswerUserObjectives;
...
public class ViewUserObjectivesAdapter extends RecyclerView.Adapter<ViewUserObjectivesAdapter.HistObjectivesViewHolder> implements Filterable {
    ...
    public ViewUserObjectivesAdapter(Context context, List<HistoryObjectives_Model> mData) {
        ...
        public HistObjectivesViewHolder(@NonNull View itemView) {
            ...
            card_essy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent request = new Intent(context, AnswerUserObjectives.class);
