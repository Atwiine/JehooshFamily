...
import com.example.jehooshfamily.ui.EmployeeSection.AnswerEmployeeVoting;
...
public class ViewEmployeeVotesAdapter extends RecyclerView.Adapter<ViewEmployeeVotesAdapter.HistVotesViewHolder> implements Filterable {
    ...
    public ViewEmployeeVotesAdapter(Context context, List<HistoryVoting_Model> mData) {
...
//        options = new RequestOptions().centerCrop().placeholder(R.drawable.markets).error(R.drawable.markets);
    ...
    @NonNull
    @Override
    public HistVotesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(context).inflate(R.layout.card_my_history, null, false);
        return new HistVotesViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HistVotesViewHolder holder, int position) {
...
//            Date date2  = dateFormat.parse(dbdate);
...
//                }
    ...
    public class HistVotesViewHolder extends RecyclerView.ViewHolder {

        TextView question, id, date, op_a, op_b, op_c, op_d, op_e, answerboss, new_qn;
        CardView card_essy;
        ...
        public HistVotesViewHolder(@NonNull View itemView) {
            super(itemView);
            ...
            card_essy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent request = new Intent(context, AnswerEmployeeVoting.class);
