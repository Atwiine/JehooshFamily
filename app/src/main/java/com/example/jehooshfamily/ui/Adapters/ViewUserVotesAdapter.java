...
import com.example.jehooshfamily.ui.UserSection.AnswerUserVoting;
...
public class ViewUserVotesAdapter extends RecyclerView.Adapter<ViewUserVotesAdapter.HistVotesViewHolder> implements Filterable {
    ...
    public ViewUserVotesAdapter(Context context, List<HistoryVoting_Model> mData) {
        ...
        public HistVotesViewHolder(@NonNull View itemView) {
            ...
            card_essy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent request = new Intent(context, AnswerUserVoting.class);
