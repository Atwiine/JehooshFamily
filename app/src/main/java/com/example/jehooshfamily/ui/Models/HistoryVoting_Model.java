...
public class HistoryVoting_Model {

    String id, question, options_a, options_b, options_c, options_d, options_e, date;

    public HistoryVoting_Model() {
    }

    public HistoryVoting_Model(String id, String question, String options_a,
                               String options_b, String options_c, String options_d, String options_e, String date) {
        this.id = id;
