...
public class AnswerEmployeeObjectives extends AppCompatActivity {
    Urls urls;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_answer_employee_objectives);

//        answer = findViewById(R.id.answer_emp_object);
...
//        answer_employee from_who,question_sent,answer_boss,options,boss_name
    ...
    private void sendObjectiveAnswer() {
        final ProgressDialog dialog = new ProgressDialog(AnswerEmployeeObjectives.this);
        dialog.setMessage("Please wait...");
        dialog.show();

//        final String objectiveanswer = this..getText().toString() +
//                this..getText().toString() + this..getText().toString() +
//                this..getText().toString() + this..getText().toString();
//
//        final String opt1 = op1.getText().toString().trim();
//        final String opt2 = op2.getText().toString().trim();
//        final String opt3 = op3.getText().toString().trim();
//        final String opt4 = op4.getText().toString().trim();
//        final String opt5 = op5.getText().toString().trim();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                dialog.dismiss();
                                Toast.makeText(AnswerEmployeeObjectives.this, "answer sent successfully", Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(AnswerEmployeeObjectives.this, "something from the db side", Toast.LENGTH_LONG).show();
                                dialog.dismiss();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
//                            answer not sent successful, please try again
                            Toast.makeText(AnswerEmployeeObjectives.this, "erredf" + e.toString(), Toast.LENGTH_LONG).show();
                            dialog.dismiss();
                        }
                    }
...
//                "answer not sent successful, please check your network and try again"
                Toast.makeText(AnswerEmployeeObjectives.this, error.toString(), Toast.LENGTH_LONG).show();
                dialog.dismiss();
            }
        }) {
    ...
    public void goback(View view) {
        startActivity(new Intent(AnswerEmployeeObjectives.this, EmployeeObjecitves.class));
    }
