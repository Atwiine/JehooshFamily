...
public class AnswersDrawing_Model {

    String id, answer, from_who, user_id, sent_question, sent_qn_id, boss_name, boss_id, date_submission,explanation;

    public AnswersDrawing_Model() {
    }


    public AnswersDrawing_Model(String id, String answer, String from_who, String user_id, String sent_question,
                                String sent_qn_id, String boss_name, String boss_id, String date_submission, String explanation) {
        this.id = id;
        this.answer = answer;
